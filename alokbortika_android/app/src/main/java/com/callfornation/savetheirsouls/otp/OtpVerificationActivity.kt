package com.callfornation.savetheirsouls.otp
...
class OtpVerificationActivity : AppCompatActivity() {
    ...
    companion object {
        var otpVerificationListener:OtpVerificationListener ?= null
        var phoneNumber: String = ""
        fun startOtpVerification(context: Context, phoneNumber: String, otpVerificationListener: OtpVerificationListener) {
            ...
            .addOnCompleteListener(this,
                OnCompleteListener<AuthResult> { task ->
                    if (task.isSuccessful) {
                        ...
                        dialog.dismiss()
                        otpVerificationListener?.onVerifySuccess()
                        finish()
                    } else {
                        Log.w(
                        ...
                        if (task.exception is FirebaseAuthInvalidCredentialsException) {
                            ...
                            otpVerificationListener?.onVerifyFailed()
                            dialog.dismiss()
                        }
                    }
                })
